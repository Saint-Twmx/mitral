...
from segmentation.nnunet_sub.network_architecture.mednextv1.MedNextV1 import MedNeXt as MedNeXt_Orig
from segmentation.nnunet_sub.training.network_training.nnUNetTrainerV2 import nnUNetTrainerV2
from segmentation.nnunet_sub.network_architecture.neural_network import SegmentationNetwork
from segmentation.nnunet_sub.utilities.nd_softmax import softmax_helper
...
class nnUNetTrainerV2_Optim_and_LR(nnUNetTrainerV2):
    ...
    def __init__(self, *args, **kwargs): 
        super().__init__(*args, **kwargs)
        self.initial_lr = 1e-3   #同初始nnunet为 0.001  而不是0.01
...
class nnUNetTrainerV2_MedNeXt_S_kernel3(nnUNetTrainerV2_Optim_and_LR):   
    ...
    def initialize_network(self):
        self.network = MedNeXt(
            ...
            deep_supervision=True,             # Can be used to test deep
