...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        ...
        "nnUNetTrainerV2": [
            "nnUNetPlansnonCT",
            "nnUNetPlansCT2",
            "nnUNetPlansallConv3x3",
            "nnUNetPlansfixedisoPatchesInVoxels",
            "nnUNetPlanstargetSpacingForAnisoAxis",
            "nnUNetPlanspoolBasedOnSpacing",
            "nnUNetPlansfixedisoPatchesInmm",
            "nnUNetPlansv2.1",
        ],
    ...
    trainers = (
        ["nnUNetTrainer"]
        + ["nnUNetTrainerNewCandidate%d" % i for i in range(1, 28)]
        + [
