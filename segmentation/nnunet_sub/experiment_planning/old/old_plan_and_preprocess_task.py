...
from nnunet_sub.experiment_planning.utils import (
    split_4d,
    crop,
    analyze_dataset,
    plan_and_preprocess,
)
from nnunet_sub.paths import nnUNet_raw_data
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--task",
        type=str,
        help="task name. There must be a matching folder in " "raw_dataset_dir",
        required=True,
    )
    parser.add_argument(
        "-pl",
        ...
        type=int,
        default=8,
        help="number of processes used for "
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="set this to 1 if you want to override "
    ...
    parser.add_argument(
        ...
        type=int,
        default=1,
        help="1 = use splitted data if already present ("
    ...
    parser.add_argument(
        ...
        type=int,
        default=0,
        help="debug only. If set to 1 this will run only"
    ...
    if task == "all":
        ...
        for t in all_tasks:
            ...
            analyze_dataset(
                ...
                num_processes=processes_lowres,
            )
            plan_and_preprocess(
                t, processes_lowres, processes_fullres, no_preprocessing
            )
    else:
