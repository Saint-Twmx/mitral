...
import numpy as np
from nnunet_sub.experiment_planning.alternative_experiment_planning.experiment_planner_baseline_3DUNet_v21_16GB import (
    ExperimentPlanner3D_v21_16GB,
)
from nnunet_sub.experiment_planning.experiment_planner_baseline_3DUNet_v21 import (
...
class ExperimentPlanner3D_v21_noResampling(ExperimentPlanner3D_v21):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnUNetPlansv2.1_noRes_plans_3D.pkl"
        )
...
class ExperimentPlanner3D_v21_noResampling_16GB(ExperimentPlanner3D_v21_16GB):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(
            self.preprocessed_output_folder, "nnUNetPlansv2.1_noRes_16GB_plans_3D.pkl"
        )
        self.preprocessor_name = "PreprocessorFor3D_NoResampling"
